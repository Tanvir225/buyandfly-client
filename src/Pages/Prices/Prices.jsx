    ...
    return (
        <div className="mt-24 bg-[#f5f5f5] ">
            ...
            <div className="h-18 bg-base-100 w-full shadow-md flex  items-center">
                <div className="md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto flex items-center justify-between w-full">
            ...
            {/* container */}
            <section className="md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto py-7 grid grid-cols-12 gap-5   w-full">
                {/* filter */}
