...
const MultiCity = ({ visible, setVisiable }) => {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-3  text-secondary ">
            <motion.div
            ...
            >
                ...
                <br />
                <div className="flex items-center mt-2  border rounded-lg h-14">
            ...
            <div>
                ...
                <motion.div className="input input-bordered h-14 mt-8 flex items-center focus:outline-none">
