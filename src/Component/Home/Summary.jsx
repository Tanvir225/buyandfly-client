...
const Summary = () => {
  ...
  return (
    <section className="space-y-7 p-5">
      <div className="md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto">
      ...
      <div className="md:max-w-5xl lg:max-w-6xl xl:max-w-7xl mx-auto grid md:gap-4 md:grid-cols-3 grid-cols-1 gap-5">
