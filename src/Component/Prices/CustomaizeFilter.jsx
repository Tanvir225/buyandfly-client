  ...
  return (
    <div>
      ...
      <div className="rounded-[10px] max-w-sm shadow-md">
        ...
        {/* checkbox start */}
        <div
          className={`mt-2 px-3 pb-3 space-y-3 transition-all duration-300 ease-in-out overflow-hidden ${
      ...
      <div className="rounded-[10px] max-w-sm shadow-md mt-3">
        ...
        <div className="px-3 mt-3">
          ...
          <div className="flex space-x-1 border border-[#DEE2E6] w-fit p-1 rounded-lg mt-3">
            <button
              className={`px-4 py-2 flex flex-col items-center ${
                selectedTime === "00-06 AM"
                  ? "bg-[#FDEADF] text-[#EF5B0C] text-xs font-medium"
                  : "bg-[#F6F6F5] text-[#7B6E7E] text-xs font-medium"
              }`}
